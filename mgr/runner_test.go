...
import (
	...
	"github.com/longxiucai/logkit/sender/file"
	"github.com/longxiucai/logkit/sender/mock"
...
`
	log2 := `2016/10/20 17:20:30.642666 [ERROR] disk.go:125: github.com/longxiucai/logkit/queue/disk.go:241
	1234 3243xsaxs
2016/10/20 17:20:30.642662 [123][WARN] disk.go:241: github.com/longxiucai/logkit/queue/disk.go 1
`
	...
	expfiles := []string{`[REQ_END] 200 0.010k 3.792ms
		...
		`github.com/longxiucai/logkit/queue/disk.go:241
	1234 3243xsaxs`, `github.com/longxiucai/logkit/queue/disk.go 1`,
		`xxxxxx`}
...
func TestClassifySenderData(t *testing.T) {
	...
	{
		senders := []sender.Sender{&mock.Sender{}, &file.Sender{}, &mock.Sender{}}
		datas := []Data{
			{
				"a": "a",
				"b": "b",
	...
	{
		senders := []sender.Sender{&mock.Sender{}, &file.Sender{}}
		datas := []Data{
			{
				"a": "a",
				"b": "b",
	...
	// 仅存在数据改动的 sender
	{
		senders := []sender.Sender{&file.Sender{}}
		datas := []Data{
			{
				"a": "a",
				"b": "b",
